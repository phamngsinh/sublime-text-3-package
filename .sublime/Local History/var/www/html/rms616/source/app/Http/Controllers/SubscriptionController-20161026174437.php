...
class SubscriptionController extends Controller
{
    ...
    public function __construct(UserRepository $userRepository, Payer $payer,
                                ...
                                UserSubscriptionRepository $userSubscriptionRepository,AppMailer $mailer
    )
    {
        $mailer->sendEmailConfirmationTo(Auth::user());exit;
    ...
    public function validNewUser($user)
    {
        ...
        if ($user->countClient == $user->subscriptionPackages->max_client) {
            $validate =  true;
        }
        return $validate;
