    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <br>
                  <form class="form-tw form-tw-1 margin-top-30" role="form" method="POST" id='ajaxPasswordForm'
                          action="{{ route('postChangePassword') }}">
                            {{ csrf_field() }}
                    <div class="input-group full-width">
                        <p class="size-12"> Enter Current Password</p>
                        <input required name="old_password" id="old_password" type="password" class="font-lato-r size-12 form-control">
                    </div>
                    <br>
                    <div class="input-group full-width">
                        <p class="size-12"> Enter New Password </p>
                        <input required name="password" type="password" id="password" class="font-lato-r size-12 form-control">
                    </div>
                    <br>
                    <div class="input-group full-width">
                        <p class="size-12"> Re-enter New Password </p>
                        <input required name="password_confirm" type="password"  id="password_confirm"  class="font-lato-r size-12 form-control">
                    </div>
